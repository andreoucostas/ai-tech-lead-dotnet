...
`.claude/commands/bootstrap.md` is the single source of truth. Follow it exactly: pre-flight checks → seven analysis passes (A1–A7) → synthesis into priority tiers → generate artifacts (`CLAUDE.md`, `TECH_DEBT.md`, `AGENTS.md`, `.github/copilot-instructions.md`) → final report with diff summary.
